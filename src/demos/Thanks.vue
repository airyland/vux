<template>
  <div>
    <group title="Thx" title-color="#04be02">
      <cell title="Router" is-link v-link="'https://github.com/vuejs/vue-router'">
      ...
      <cell title="Style" is-link v-link="'https://github.com/weui/weui'">
        <span class="demo-icon" slot="icon">&#xe638;</span>
        <span slot="value"><span class="demo-icon">&#xe600</span>Based on Weui</span>
      </cell>
      <cell title="Dev && Build" is-link v-link="'https://github.com/webpack/webpack'">
      ...
      <cell title="Demo Icon" is-link v-link="'http://iconfont.cn/'">
        <span class="demo-icon" slot="icon">&#xe619;</span>
